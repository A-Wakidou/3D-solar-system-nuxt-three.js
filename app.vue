<script setup>
  ...
  const planetsData = [
    {
      name: 'Mercure',
      path: '/models/mercury/scene.gltf',
      size: 0.382,
      semiMajorAxis: 180,
      semiMinorAxis: 174,
      inclination: 7.01,
    ...
    {
      name: 'Jupiter',
      path: '/models/jupiter/scene.gltf',
      size: 11.209,
      semiMajorAxis: 900,
      semiMinorAxis: 870,
      inclination: 1.31,
    ...
    {
      name: 'Neptune',
      path: '/models/neptune/scene.gltf',
      size: 3.883,
      semiMajorAxis: 1800,
      semiMinorAxis: 1794,
      inclination: 1.77,
