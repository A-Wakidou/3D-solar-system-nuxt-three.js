  ...
  const planetsData = [
    ...
    },
    {
      ...
      characteristics: {
        ...
        rotationPeriod: '24,622962 h',
        rotationSpeed: 868.22, // km/h
        orbit: {
          semiMajorAxis: 57909050, // km
          orbitalSpeed: 24.08, // km/s
          orbitalPeriod: 686.885, // days
          satellites: [],
        },
      },
      moons: [],
    },
    {
      ...
      characteristics: {
        ...
        averageTemperature: -163, // °C
        rotationPeriod: '9 h 55 min 27,3 s',
        rotationSpeed: 47051, // km/h
        orbit: {
          semiMajorAxis: 778340000, // km
          orbitalSpeed: 13.0585, // km/s
          orbitalPeriod: 4332.01, // days
          satellites: [],
        },
      },
      moons: [],
    },
    {
      ...
      characteristics: {
        ...
        averageTemperature: -191.9, // °C
        rotationPeriod: '10 h 33 min',
        rotationSpeed: 34821, // km/h
        orbit: {
          semiMajorAxis: 1426700000, // km
          orbitalSpeed: 9.6407, // km/s
          orbitalPeriod: 10754, // days
          satellites: [],
        },
      },
      moons: [],
    },
    {
      ...
      characteristics: {
        ...
        averageTemperature: -216, // °C
        rotationPeriod: '-17.23992 h',
        rotationSpeed: 9320, // km/h
        orbit: {
          semiMajorAxis: 2870700000, // km
          orbitalSpeed: 6.796732, // km/s
          orbitalPeriod: 30698, // days
          satellites: [],
        },
      },
      moons: [],
    }, // Uranus tourne rétrograde
    {
      ...
      characteristics: {
        ...
        averageTemperature: -226, // °C
        rotationPeriod: '16 h 6,6 min',
        rotationSpeed: 9660, // km/h
        orbit: {
          semiMajorAxis: 4498400000, // km
          orbitalSpeed: 5.43248, // km/s
          orbitalPeriod: 60216.8, // days
          satellites: [],
        },
      },
      moons: [],
...
<template>
  <div>
    ...
    <Scene3D
      ...
      v-model:controls="controls"
      v-model:planet-groups="planetGroups"
      @modelsLoadingComplete="loading = false"
    />
    <SelectPlanet
      :planet-groups="planetGroups"
      :camera="camera"
      :controls="controls"
